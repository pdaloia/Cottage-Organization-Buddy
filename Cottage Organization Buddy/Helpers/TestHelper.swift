...
class TestHelper {
    ...
    static func loadTestModel(into model: CottageTrip) {
        ...
        //load the groceries
        let bananas: Grocery = Grocery(productName: "Banana", price: 2.00, quantity: 5, assignedTo: phil.firebaseUserID)
        let apples: Grocery = Grocery(productName: "Apple", price: 1.50, quantity: 10, assignedTo: phil.firebaseUserID)
        let burgers: Grocery = Grocery(productName: "Burger", price: 5.00, quantity: 10, assignedTo: vic.firebaseUserID)
        let popsicles: Grocery = Grocery(productName: "Popsicle", price: 2.50, quantity: 20, assignedTo: medei.firebaseUserID)
